...
#define U_SEARCH_VELOCITY           (5.0*60)
#define U_LATCH_VELOCITY            (2.0*60)
#define U_LATCH_BACKOFF             5.0
...
#define V_SEARCH_VELOCITY           (5.0*60)
#define V_LATCH_VELOCITY            (2.0*60)
#define V_LATCH_BACKOFF             5.0
...
#define A_SEARCH_VELOCITY           (5.0*60)
...
#define B_SEARCH_VELOCITY           (5.0*60)
